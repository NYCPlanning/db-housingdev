...
SELECT
	...
	CASE WHEN units_2009 <> 0 THEN units_2009 - coalesce(units_2008,units_2007) ELSE 0 END as units_2009_increm,
	CASE WHEN units_2010 <> 0 THEN units_2010 - coalesce(units_2009,units_2008,units_2007) ELSE 0 END as units_2010_increm,
	CASE WHEN units_2011 <> 0 THEN units_2011 - coalesce(units_2010,units_2009,units_2008,units_2007) ELSE 0 END as units_2011_increm,
	CASE WHEN units_2012 <> 0 THEN units_2012 - coalesce(units_2011,units_2010,units_2009,units_2008,units_2007) ELSE 0 END as units_2012_increm,
	CASE WHEN units_2013 <> 0 THEN units_2013 - coalesce(units_2012,units_2011,units_2010,units_2009,units_2008,units_2007) ELSE 0 END as units_2013_increm,
	CASE WHEN units_2014 <> 0 THEN units_2014 - coalesce(units_2013,units_2012,units_2011,units_2010,units_2009,units_2008,units_2007) ELSE 0 END as units_2014_increm,
	CASE WHEN units_2015 <> 0 THEN units_2015 - coalesce(units_2014,units_2013,units_2012,units_2011,units_2010,units_2009,units_2008,units_2007) ELSE 0 END as units_2015_increm,
	CASE WHEN units_2016 <> 0 THEN units_2016 - coalesce(units_2015,units_2014,units_2013,units_2012,units_2011,units_2010,units_2009,units_2008,units_2007) ELSE 0 END as units_2016_increm,
	CASE WHEN units_2017 <> 0 THEN units_2017 - coalesce(units_2016,units_2015,units_2014,units_2013,units_2012,units_2011,units_2010,units_2009,units_2008,units_2007) ELSE 0 END as units_2017_increm,
	units_latest,
	cofo_latest,
	cofo_earliest,
	cofo_latesttype
