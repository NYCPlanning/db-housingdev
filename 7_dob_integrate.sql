...
SET
	...
	units_complete_2008_increm_net = 
		CASE 
			WHEN dcp_category_development = 'Alteration' AND b.units_2008_increm <> 0 AND (b.units_2007) = 0 THEN b.units_2008_increm - units_exist 
			ELSE b.units_2008_increm 
		END,
	units_complete_2009_increm_net = 
		CASE 
			WHEN dcp_category_development = 'Alteration' AND b.units_2009_increm <> 0 AND (b.units_2007 + b.units_2008) = 0 THEN b.units_2009_increm - units_exist 
			ELSE b.units_2009_increm 
		END,
	units_complete_2010_increm_net = 
		CASE 
			WHEN dcp_category_development = 'Alteration' AND b.units_2010_increm <> 0 AND (b.units_2007 + b.units_2008 + b.units_2009) = 0 THEN b.units_2010_increm - units_exist 
			ELSE b.units_2010_increm 
		END,
	units_complete_2011_increm_net = 
		CASE 
			WHEN dcp_category_development = 'Alteration' AND b.units_2011_increm <> 0 AND (b.units_2007 + b.units_2008 + b.units_2009 + b.units_2010) = 0 THEN b.units_2011_increm - units_exist 
			ELSE b.units_2011_increm 
		END,
	units_complete_2012_increm_net = 
		CASE 
			WHEN dcp_category_development = 'Alteration' AND b.units_2012_increm <> 0 AND (b.units_2007 + b.units_2008 + b.units_2009 + b.units_2010 + b.units_2011) = 0 THEN b.units_2012_increm - units_exist 
			ELSE b.units_2012_increm 
		END,
	units_complete_2013_increm_net = 
		CASE 
			WHEN dcp_category_development = 'Alteration' AND b.units_2013_increm <> 0 AND (b.units_2007 + b.units_2008 + b.units_2009 + b.units_2010 + b.units_2011 + b.units_2012) = 0 THEN b.units_2013_increm - units_exist 
			ELSE b.units_2013_increm 
		END,
	units_complete_2014_increm_net = 
		CASE 
			WHEN dcp_category_development = 'Alteration' AND b.units_2014_increm <> 0 AND (b.units_2007 + b.units_2008 + b.units_2009 + b.units_2010 + b.units_2011 + b.units_2012 + b.units_2013) = 0 THEN b.units_2014_increm - units_exist 
			ELSE b.units_2014_increm 
		END,
	units_complete_2015_increm_net = 
		CASE 
			WHEN dcp_category_development = 'Alteration' AND b.units_2015_increm <> 0 AND (b.units_2007 + b.units_2008 + b.units_2009 + b.units_2010 + b.units_2011 + b.units_2012 + b.units_2013 + b.units_2014) = 0 THEN b.units_2015_increm - units_exist 
			ELSE b.units_2015_increm 
		END,
	units_complete_2016_increm_net = 
		CASE 
			WHEN dcp_category_development = 'Alteration' AND b.units_2016_increm <> 0 AND (b.units_2007 + b.units_2008 + b.units_2009 + b.units_2010 + b.units_2011 + b.units_2012 + b.units_2013 + b.units_2014 + b.units_2015) = 0 THEN b.units_2016_increm - units_exist 
			ELSE b.units_2016_increm 
		END,
	units_complete_2017_increm_net = 
		CASE 
			WHEN dcp_category_development = 'Alteration' AND b.units_2017_increm <> 0 AND (b.units_2007 + b.units_2008 + b.units_2009 + b.units_2010 + b.units_2011 + b.units_2012 + b.units_2013 + b.units_2014 + b.units_2015 + b.units_2016) = 0 THEN b.units_2017_increm - units_exist 
