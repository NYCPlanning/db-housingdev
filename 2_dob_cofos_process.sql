...
(SELECT
	*,
	coalesce(u_2017_totalexist,u_2016_totalexist,u_2015_totalexist,u_2014_totalexist, u_2013_totalexist,u_2012_totalexist,u_2011_totalexist,u_2010_totalexist,u_2009_totalexist,u_2008_totalexist,u_2007_totalexist) as u_latest
FROM
	dob_cofos_byjob)
